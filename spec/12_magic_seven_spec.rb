...
describe MagicSeven do
  ...
  describe '#play' do
    ...
    context 'when the random number is 1245' do
      # remove the 'x' before running this test

      game_large_nr = MagicSeven.new(1245)

      it 'will return 7' do
        expect(game_large_nr.play).to eq(7)
      end
    end
  end
end
